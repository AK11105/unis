...
- **Semester contribution:** ~€340/semester (includes Deutschlandticket for public transport across Germany; mobility component alone is €234.57 from WS 26/27)
- **No application fee**

> Source: https://sc.informatik.rwth-aachen.de/en/studium/master/master-data-science/faq/
...
> Source: https://sc.informatik.rwth-aachen.de/de/studium/master/master-data-science/application-for-admission/
...
> Source: https://sc.informatik.rwth-aachen.de/en/studium/master/informatik/
...
> Source: https://sc.informatik.rwth-aachen.de/en/studium/master/sse/
...
> Source: https://sc.informatik.rwth-aachen.de/en/studium/master/master-hcis/
...
> [Planning assumption] Expected to remain similar for 2027 intake. Always verify on official RWTH page.
...
| Item | Date |
|------|------|
| Non-EU application deadline (WS) | **1 March** |
| Non-EU application deadline (SS) | **1 September** |
| EU application deadline (WS) | **15 July** |
| EU application deadline (SS) | **15 January** |
| Admission decisions (March deadline) | ~May |

> Latest published cycle. 2027-specific dates not yet confirmed.
...
(To be filled — requires manual research of specific professors)
...
- [ ] Bachelor's degree (CS / Maths / Physics)
- [ ] Official transcript
- [ ] English certificate (IELTS/TOEFL)
- [ ] GRE General Test (non-EU applicants)
- [ ] APS certificate (Indian applicants)
- [ ] Module descriptions with cover sheet
- [ ] Passport copy
