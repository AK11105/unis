...
> Source: https://www.tudelft.nl/onderwijs/studievoorlichting/praktische-zaken/collegegeld-en-financien
...
> Note: For Aerospace Engineering these are strict minimums; for CS/DSAI they are competitive benchmarks.
...
|------|------|
| Applications open | 15 October |
| Non-EU deadline (CS, DSAI) | **15 January** |
| Other programmes | 1 April |
| Semester start | September |

> [Planning assumption] Expected to remain similar for 2027 intake.
...
> Note: TU Delft is one of the most expensive options for non-EU students. MSc fees are significantly higher than BSc fees.
...
- [ ] Bachelor's degree (research university, ≥75% GPA)
- [ ] Official transcript
- [ ] English certificate (IELTS 7.0 / TOEFL)
- [ ] GRE scores (required for CS/DSAI)
- [ ] CV
- [ ] Motivation letter
- [ ] Passport copy
