...
These documents are needed for **every** application:

| # | Document | Notes |
|---|----------|-------|
| 1 | Passport | Valid through at least 2028 |
| 2 | Bachelor's Degree Certificate | Or provisional/expected completion certificate |
| 3 | Official Transcript of Records | Sealed/certified, all semesters |
| 4 | English Language Certificate | IELTS Academic or TOEFL iBT |
...
!!! warning "By November 2026 (earliest deadlines)"
    - Statement of Purpose — ETH version first (Nov 30 deadline)
    - ETH-specific: High school cert, Declaration of Consent, ESOP pre-proposal
    - All recommendation letter writers notified and submitting
